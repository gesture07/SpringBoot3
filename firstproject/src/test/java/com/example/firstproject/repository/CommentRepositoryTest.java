...
class CommentRepositoryTest {
    ...
    void findByArticledId() {
        ...
        //Case 3: 9번 게시글의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList();
            //4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "9번은 게시글이 없음");
        }
        //Case 4: 999번 게시글의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList();
            //4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "999번은 게시글이 없음");
        }
        //Case 5: -1번 게시글의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList();
            //4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "-1번은 게시글이 없음");
        }
    ...
    void findByNickname() {
        ...
        //Case 3: null의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList();
            //4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "null 댓글 모두 출력");
        }
        //Case 4: ""의 모든 댓글 조회
        {
            //1. 입력 데이터 준비
